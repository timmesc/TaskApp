...
Task App is an application that will allow a user to create tasks for any day on the calender. It will then give them the ability to mark the completion of the task and also delte. 
